...
export default function OrdersPage() {
  ...
  return (
    <div className="min-h-screen flex justify-center lg:p-0  bg-gray-50">
      <div className="w-full max-w-[600px] space-y-4 px-4">
          ...
          {currentOrders.map(order => (
            <div key={order.id} className="bg-white rounded-xl overflow-hidden shadow-sm ">
              <div className="p-4">
                ...
                <div className="flex gap-16 lg:gap-32 mt-4">
                  <button className="flex-1 flex items-center w-[150px] justify-center gap-1 text-xs border border-gray-300 rounded-lg py-2 px-3 bg-gray-50">
